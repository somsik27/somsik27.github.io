...
export const invitation = {
  ...
  hero: {
    imageSrc: 'images/generated-wedding/studio-hero-bridal-face-v4.png',
    imageAlt: '스튜디오 웨딩 콘셉트로 촬영한 최윤식과 정솜이',
  },
  invitationMessage: [
    '이쁜 솜이야 안녕?',
    '어느새 결혼과 졸업이 다가왔어',
    '이미 솜이랑 있을때가 다른데 비교할 수 없이 즐거운데',
    '같이살면 얼마나 더 즐거울까?',
    '내가 평생 DIY 해줄게',
    '앞으로도 즐겁게 같이살자',
    '제일 행복한 생일이 되어라',
  ...
  film: {
    title: 'Wedding Film',
    videoUrl: '',
    thumbnailSrc: 'images/generated-wedding/studio-hero-bridal-face-v4.png',
    thumbnailAlt: '최윤식과 정솜이의 영상 썸네일',
  },
  gallery: [
    {
      src: 'images/generated-wedding/studio-hero-bridal-face-v4.png',
